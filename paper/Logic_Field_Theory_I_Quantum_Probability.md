...
![L-Flow: Monotonic Descent on N=3 Permutohedron](figures/outputs/figure_lflow_trajectory.png)
...
![Quantum Bridge: Permutohedron → Hilbert Space](figures/outputs/figure_quantum_bridge.png)

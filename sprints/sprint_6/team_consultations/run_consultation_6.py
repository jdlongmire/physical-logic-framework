#!/usr/bin/env python3
"""
Run Team Consultation 6: Lean Proof Strategies for Category C
Sprint 6 Day 4 - Get expert guidance on 4 remaining novel theorem proofs
"""
...
async def run_consultation_6():
    """Run consultation 6 to get Lean proof strategies."""
    ...
    # Read prompt
    prompt_path = 'C:/Users/jdlon/OneDrive/Documents/physical_logic_framework/sprints/sprint_6/team_consultations/consultation_6_prompt.txt'
    with open(prompt_path, 'r', encoding='utf-8') as f:
        prompt = f.read()

    print("\n" + "="*70)
    print("TEAM CONSULTATION 6: Lean Proof Strategies (Category C)")
    print("="*70)
    ...
    result = await bridge.consult_lean_proof(
        code=prompt,  # Prompt describes the theorems
        issue="Need proof strategies for 4 novel theorems in BornRuleNonCircularity.lean",
        context="Sprint 6 Day 4: Categories A & B complete (8/12), Category C needs guidance"
    )
    ...
    # Save JSON
    json_path = f'C:/Users/jdlon/OneDrive/Documents/physical_logic_framework/sprints/sprint_6/team_consultations/consultation_6_{timestamp}.json'
    with open(json_path, 'w', encoding='utf-8') as f:
        json.dump(result, f, indent=2, ensure_ascii=False)

    # Save formatted text
    txt_path = f'C:/Users/jdlon/OneDrive/Documents/physical_logic_framework/sprints/sprint_6/team_consultations/consultation_6_{timestamp}.txt'
    with open(txt_path, 'w', encoding='utf-8') as f:
        f.write("="*70 + "\n")
        f.write("TEAM CONSULTATION 6: Lean Proof Strategies (Category C)\n")
        f.write("="*70 + "\n\n")
    ...
    if successful:
        ...
        if avg_score >= 0.70:
            ...
            print(f"\n[CONCERN] Score below target, but guidance still useful")
        ...
        for r in successful:
            ...
            if source in result.get('quality_scores', {}):
                ...
                print(f"  - {source.upper()}: {lean_score:.2f}/1.0 (Lean tactics & syntax)")
...
if __name__ == "__main__":
    result = asyncio.run(run_consultation_6())
